...
"""
def fitParticle(folder, particleId=None, filename = None, jumpWeight = 5000, minJump = 2.5, npointsSmooth = 3):
    ...
    # We only consider excitations of dI>minJump*std(background)
    if fit2.x[1]<np.std(background)*minJump:
